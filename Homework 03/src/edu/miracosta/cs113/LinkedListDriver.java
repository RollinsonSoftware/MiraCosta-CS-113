...
public class LinkedListDriver 
{
	public static void main(String[] args)
	{
		...
		//searching for given student and removing from list.
		System.out.println("\nNow lets remove a student by name");
		System.out.print("Whom would you like the remove?");
		Student search =  new Student();
		search.setAll();
		list.removeStudent(search);
		
		showList(list);
	}
	public static void showList(SingleLinkedList<Student> list)
	{
