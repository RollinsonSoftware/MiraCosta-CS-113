...
public class AVLTree<E extends Comparable<E>> extends BinarySearchTreeWithRotate<E>
{
	...
	/**
	 * Add starter method found on page 484.
	 * pre: The item to insert implements the comparable interface.
	 * @param object, The item being inserted.
	 * @return true if the object is inserted; false if the object
	 * 				already exists in the tree.
	 * @throws ClassCastException if the parameter is not Comparable 
	 */
	@Override
	 ...
	 * @param item, The object to be inserted into the tree.
	...
	/**
	 * Method to rebalance left from page 487.
	 * pre: localRoot is the root of an AVL subtree that is critically
	 * 			left-heavy.
	...
	private AVLNode<E> rebalanceLeft(AVLNode<E> localRoot)
	{
		...
		{
			/**
			 * In this case the leftChild (the root)
			 * and the root (new right child) will 
	...
	/**
	 * Found on page 488 and on the slides.
	 * Decrements the balance when there is an imbalance on the left.
	 * @param node, the node needing to be rotated.
	 */
	private void decrementBalance(AVLNode<E> node)
	{
		...
		{
			//Overall height has not increased.
			increase = false;
		}
	}
	/**
	 * Increments the balance when there is an imbalance on the right.
	 * @param node, the node needing to be rotated.
	 */
